...
def test_swap_newest():
    # Arrange
    item_a = Decor(age=8.0)
    item_b = Electronics(age=None)
    item_c = Decor(age = 2.0)
    tai = Vendor(
        inventory=[item_c, item_b, item_a]
    )

    item_d = Clothing(age=None)
...
def test_swap_newest_all_ages_none():
    # Arrange
    item_a = Decor(age=None)
    item_b = Electronics(age=None)
    item_c = Decor(age=None)
    tai = Vendor(
        inventory=[item_c, item_b, item_a]
    )

    item_d = Clothing(age=None)
    item_e = Decor(age=None)
...
def test_swap_newest_one_vendor_ages_none():
    # Arrange
    item_a = Decor(age=None)
    item_b = Electronics(age=None)
    item_c = Decor(age=None)
