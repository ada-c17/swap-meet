...
def test_swap_best_by_category():
    ...
    result = tai.swap_best_by_category(
        other=jesse, my_priority="Clothing", their_priority="Decor"
    )
    # Assert
    assert result
...
def test_swap_best_by_category_no_other_inventory_is_false():
    ...
    result = tai.swap_best_by_category(
        other=jesse, my_priority="Decor", their_priority="Clothing"
    )
...
def test_swap_best_by_category_no_match_is_false():
    ...
    # Act
    result = tai.swap_best_by_category(
        other=jesse, my_priority="Clothing", their_priority="Clothing"
    )
...
def test_swap_best_by_category_no_other_match_is_false():
    ...
    # Act
    result = tai.swap_best_by_category(
        other=jesse, my_priority="Electronics", their_priority="Decor"
    )
    # Assert
    assert not result
    assert len(tai.inventory) == 3
