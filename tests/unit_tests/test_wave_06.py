...
def test_swap_best_by_category():
    ...
    assert item_f in tai.inventory #swapped from jesse's
    assert item_a in tai.inventory
    assert item_b in tai.inventory
    #test jesse's inventory
    assert item_f not in jesse.inventory
    assert item_d in jesse.inventory
    assert item_e in jesse.inventory
    assert item_c in jesse.inventory #swapped from tai's
...
def test_swap_best_by_category_reordered():
    ...
    assert len(jesse.inventory) == 3
    assert item_f in tai.inventory #swapped from jesse's
    assert item_c not in tai.inventory #swapped to jesse's
    assert item_a in tai.inventory
    assert item_b in tai.inventory
    #test jesses's inventory
    assert item_f not in jesse.inventory #swapped to tai's
    assert item_c in jesse.inventory #swapped from tai's
    assert item_d in jesse.inventory 
    assert item_e in jesse.inventory 
