...
def test_swap_best_by_category_reordered():
    ...
    assert len(tai.inventory)  == 3
    assert len(jesse.inventory) == 3
    assert item_f in tai.inventory and item_c in jesse.inventory
    assert item_c not in tai.inventory and item_f not in jesse.inventory
...
def test_swap_best_by_category_no_other_match_is_false():
    ...
    assert len(tai.inventory)  == 3
    assert len(jesse.inventory) == 3
    assert item_b in tai.inventory and item_e in jesse.inventory
